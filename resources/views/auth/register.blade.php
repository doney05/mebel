    ...
    <div class="content-3-6 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <h3 class="title-text">Daftar Sekarang</h3>
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div style="margin-bottom: 1.75rem;">
              ...
              <div class="d-flex w-100 div-input">
                <input class="input-field @error('name') is-invalid @enderror" type="text" name="name" id="name" placeholder="Nama Pengguna" autocomplete="on"
            ...
            <div style="margin-top: 1rem;">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field @error('password') is-invalid @enderror" type="password" name="password" id="password-content-3-6" placeholder="Your Password"
          ...
          <div class="row mt-3">
            <div class="col-8">
                <p style="color: white">Daftar dengan Google?</p>
            </div>

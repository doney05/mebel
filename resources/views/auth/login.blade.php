<!DOCTYPE html>
  <html lang="en">
    ...
    <body>
       <section class="w-100" style="box-sizing: border-box; background-color: #232130; max-height: auto;">
    <style scoped>
    ...
    <div class="content-3-6 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <p class="caption-text">Silahkan login menggunakan akun yang <br>
            terdaftar di situs web.</p>
          <form style="margin-top: 1.5rem;" action="{{ url('login/store') }}" method="post">
            @csrf
            <div style="margin-bottom: 1.75rem;">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field" type="email" name="email" id="email" placeholder="Email Pengguna" autocomplete="on"
                  required>
              </div>
            </div>
            ...
            <button class="btn btn-fill text-white d-block w-100" type="submit">Masuk ke Aplikasi</button>
          </form>
          <p class="text-center bottom-caption">Belum Punya Akun?
            <a href="{{  url('register') }}">
                <span class="green-bottom-caption">Daftar Sekarang</span>
            </a>
          </p>
          <div class="row">
            <div class="col-8">
                <p style="color: white">Masuk dengan Google?</p>
            </div>
            <div class="col-4 text-end">
                <a href="{{ url('redirect-google') }}">
                    <img src="{{ asset('client/assets/img/google.png') }}" alt="" style="width: 20%">
                </a>
            </div>
          </div>
        </div>

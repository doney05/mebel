    ...
    <div class="col-lg-6">
      <div class="users">
        <div class="card">
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/1.jpg') }}" alt=""></div>
            <div class="info">
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/2.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/3.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/4.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
    ...
    <div class="col-lg-6">
      <div class="users">
        <div class="card">
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/5.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/6.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/7.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
          ...
          <div class="user">
            <div class="uImg"><img src="{{ asset('admin/assets/img/act/8.jpg') }}" alt=""></div>
            <div class="info">
              <h1>Josephine Walker</h1>
              <p>Apple Iwork 08 Review</p>
            </div>
